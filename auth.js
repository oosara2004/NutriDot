...
const firebaseConfig = {
  ...
  auth.onAuthStateChanged(user => {
    ...
    if (user) {
      ...
      // If on signin/signup page while logged in, redirect to account
      ...
      const protectedPages = ['Account.html', 'addMember.html'];
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // Change SignUp button to Account button if logged in
    const accountBtn = document.getElementById('account-btn');
    if (accountBtn && auth.currentUser) {
